...
siteControllers.controller('siteCtrl', ['$scope', 'Meta', 'Menu', '$http',
...
siteControllers.controller('quienesSomosCtrl', ['$scope', 'Meta', 'Menu', '$http', '$location',
...
siteControllers.controller('bodasPreferidasCtrl', ['$scope', 'Meta', 'Menu', '$http', '$location',
    function($scope, Meta, Menu, $http, $location) {
        $scope.siteMeta = Meta.tags;
        $scope.siteMeta.description = "Las preferidas de Lumiere";
        $scope.siteMeta.title = "Las preferidas de Lumiere";
        ...
        $scope.showPhoto = function(index) {
            $scope.position = ($scope.pagination.page * 20) + index;
            $scope.fullscreen = true;
            $scope.photoBackground = 'url(galleries/preferidas/' + $scope.photos[$scope.position].file + ')';
        };
